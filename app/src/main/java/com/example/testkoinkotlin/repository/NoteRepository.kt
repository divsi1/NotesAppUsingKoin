package com.example.testkoinkotlin.repository

import android.util.Log
import androidx.lifecycle.LiveData
import com.example.testkoinkotlin.persistence.Note
import com.example.testkoinkotlin.persistence.NoteDao

import kotlinx.coroutines.*


class NoteRepository constructor(val noteDao: NoteDao) {
